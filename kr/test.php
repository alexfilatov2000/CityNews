...
$login = 'admin@citynews.com.ua'; // замените test@example.com на адрес электронной почты, с которого производится отправка (поскольку логин совпадает с адресом отправителя - данная переменная используется и как логин, и как адрес отправителя)
$password = 'sdav89789ERETD_citynews'; // замените password на пароль от почтового ящика, с которого производится отправка
$to = '7rich77@gmail.com'; // замените to@example.com на адрес электронной почты получателя письма
